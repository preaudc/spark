...
<<<<<<< HEAD:core/src/main/scala/org/apache/spark/deploy/master/SparkCuratorUtil.scala
private[deploy] object SparkCuratorUtil extends Logging {
=======
private[spark] object SparkCuratorUtil extends Logging {
>>>>>>> upstream/master:core/src/main/scala/org/apache/spark/deploy/SparkCuratorUtil.scala
