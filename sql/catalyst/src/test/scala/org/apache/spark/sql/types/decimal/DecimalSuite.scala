...
<<<<<<< HEAD:sql/catalyst/src/test/scala/org/apache/spark/sql/types/decimal/DecimalSuite.scala
...
>>>>>>> upstream/master:sql/catalyst/src/test/scala/org/apache/spark/sql/types/decimal/DecimalSuite.scala
