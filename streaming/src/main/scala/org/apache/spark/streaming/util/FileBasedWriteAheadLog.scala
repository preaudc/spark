...
<<<<<<< HEAD:streaming/src/main/scala/org/apache/spark/streaming/util/WriteAheadLogManager.scala
...
>>>>>>> upstream/master:streaming/src/main/scala/org/apache/spark/streaming/util/FileBasedWriteAheadLog.scala
